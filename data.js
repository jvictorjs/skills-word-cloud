...
const PROJECTS = [
  {
    ...
    year: 2022,
    tech: "Vue",
    description: "Versão web do aplicativo TremdGol: estatísticas de partidas de futebol ao vivo e um canvas para registrar eventos do jogo.",
    language: "English",
    languageSymbol: "EN",
  ...
  },
  {
    ...
    year: 2022,
    tech: "React",
    description: "Página web criada para disponibilização de conteúdo em formato de vídeo aulas.",
  ...
  },
  {
    ...
    year: 2021,
    tech: "React Native",
    description: "Aplicativo móvel com estatísticas ao vivo de jogos de futebol compatível com Android.",
    language: "English",
    languageSymbol: "EN",
  ...
  },
  {
    ...
    year: 2022,
    tech: "Vue",
    description: "Página web criada para mostrar as ferramentas e tecnologias que eu domino.",
    language: "English",
    languageSymbol: "EN",
  ...
  
  {
    ...
    year: 2022,
    tech: "Vue",
    description: "Página para divulgação de informações pessoais em formato que simula uma interface de aplicativo de conversas.",
    language: "English",
    languageSymbol: "EN",
  ...
  
  {
    ...
    year: 2021,
    tech: "Vue",
    description: "Sistema web para avaliação de servidores do Ministério da economia. Utilizado por mais de 10 mil pessoas.",
  ...
  },
  {
    ...
    year: 2021,
    tech: "Qlik Sense",
    description: "Painel criado com Qlik Sense para mostrar dados do Ministério da Economia do Brasil.",
    language: "Brazilian Portuguese",
    languageSymbol: "PT",
  ...
  },
  {
    ...
    year: 2021,
    tech: "Angular",
    description: "Página criada para mostrar dados estatísticos de jogos de futebol em tempo real.",
    language: "Brazilian Portuguese",
    languageSymbol: "PT",
 ...
 
  {
    ...
    year: 2021,
    tech: "Angular",
    description: "Página pessoal que serve como portfolio, reunindo informações profissionais básicas e algumas micro-aplicações de demonstração.",
    language: "English",
    languageSymbol: "EN",
  ...
  },
  {
    ...
    year: 2020,
    tech: "Node.js",
    description: "Aplicação que disponibiliza dados estatísticos de jogos de futebol em formato JSON. (REST API)",
    language: "English",
    languageSymbol: "EN",
  ...
  },
  {
    ...
    description: "A useful chatbot that reminds you when it is time to take that pill. This is one of many Telegram Bot I created.",
    language: "Brazilian Portuguese",
    languageSymbol: "PT",
    urlLabel: "",
    url: "",
